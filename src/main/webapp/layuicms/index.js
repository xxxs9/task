...
layui.config({//基础目录
    ...
    $api:'api',
    bodyTab:'bodyTab'
}).use(['bodyTab', 'form', 'element', 'layer', 'jquery', 'ajaxExtention', '$tool','$api'], function () {
    var form = layui.form,
        layer = layui.layer,
    ...
    tab = layui.bodyTab({
        ...
        url: $tool.getContext() + 'menu/menuList.do' //获取菜单json地址
    });
    ...
    function showNotice() {
        layer.open({
            ...
            btn: ['好的'],
            moveType: 1,
            content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p>欢迎使用本系统</p></div>',
